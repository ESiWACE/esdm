...
test/CMakeFiles/test-plugin-dataset.exe.dir/plugin-dataset.c.o: /home/ok/ESD-Middleware/src/test/plugin-dataset.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/ok/ESD-Middleware/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object test/CMakeFiles/test-plugin-dataset.exe.dir/plugin-dataset.c.o"
	cd /home/ok/ESD-Middleware/build/test && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/test-plugin-dataset.exe.dir/plugin-dataset.c.o   -c /home/ok/ESD-Middleware/src/test/plugin-dataset.c
...
test/CMakeFiles/test-plugin-dataset.exe.dir/plugin-dataset.c.i: cmake_force
	...
	cd /home/ok/ESD-Middleware/build/test && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /home/ok/ESD-Middleware/src/test/plugin-dataset.c > CMakeFiles/test-plugin-dataset.exe.dir/plugin-dataset.c.i
...
test/CMakeFiles/test-plugin-dataset.exe.dir/plugin-dataset.c.s: cmake_force
	...
	cd /home/ok/ESD-Middleware/build/test && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /home/ok/ESD-Middleware/src/test/plugin-dataset.c -o CMakeFiles/test-plugin-dataset.exe.dir/plugin-dataset.c.s
...
test/test-plugin-dataset.exe: /home/ok/install/lib/libhdf5.so
test/test-plugin-dataset.exe: /usr/lib/x86_64-linux-gnu/libz.so
test/test-plugin-dataset.exe: /usr/lib/x86_64-linux-gnu/libdl.so
test/test-plugin-dataset.exe: /usr/lib/x86_64-linux-gnu/libm.so
test/test-plugin-dataset.exe: test/CMakeFiles/test-plugin-dataset.exe.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/ok/ESD-Middleware/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable test-plugin-dataset.exe"
	cd /home/ok/ESD-Middleware/build/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-plugin-dataset.exe.dir/link.txt --verbose=$(VERBOSE)
...
test/CMakeFiles/test-plugin-dataset.exe.dir/clean:
	cd /home/ok/ESD-Middleware/build/test && $(CMAKE_COMMAND) -P CMakeFiles/test-plugin-dataset.exe.dir/cmake_clean.cmake
.PHONY : test/CMakeFiles/test-plugin-dataset.exe.dir/clean

test/CMakeFiles/test-plugin-dataset.exe.dir/depend:
	cd /home/ok/ESD-Middleware/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/ok/ESD-Middleware/src /home/ok/ESD-Middleware/src/test /home/ok/ESD-Middleware/build /home/ok/ESD-Middleware/build/test /home/ok/ESD-Middleware/build/test/CMakeFiles/test-plugin-dataset.exe.dir/DependInfo.cmake --color=$(COLOR)
