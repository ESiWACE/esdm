...
int
lfs_open (char *df, int flags, mode_t mode)
{
  filename = strdup (df);
...
int
lfs_find_chunks (size_t a, size_t b, int index, struct lfs_record *my_recs, struct lfs_record **chunks_stack, int *ch_s)
{
