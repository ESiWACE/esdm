// This test tests if HDF5 Vol operates as expected by using a HDF5 example.

// This file is part of HDF5 VOL, but no license information was embedded in the file.
// Please checkout the original code: svn checkout https://svn.hdfgroup.uiuc.edu/hdf5/features/vol/
